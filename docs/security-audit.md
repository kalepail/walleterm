...
> Current security tracking lives in `docs/security-remediation-plan.md`.
...
- **Fix:** Replace with `randomBytes(8)` from `node:crypto`, matching `wallet.ts`:
  ...
  ```
- **Status:** [x] Addressed in `docs/security-remediation-plan.md`
...
- **Status:** [x] Addressed in `docs/security-remediation-plan.md` (`max_payment_amount`, stderr amount display, `--yes` override)
...
- **Status:** [x] Addressed in `docs/security-remediation-plan.md` (runtime schema validation with Zod)
...
- **Status:** [~] Documented and warned at runtime; platform limitation remains
...
- **Status:** [x] Addressed in `docs/security-remediation-plan.md` (warning-based enforcement)
...
- **Status:** [~] Partially addressed in `docs/security-remediation-plan.md`
